...
const $moduleName = 'hashi::utxo';
export const UtxoId = new MoveStruct({ name: `${$moduleName}::UtxoId`, fields: {
        txid: bcs.Address,
        vout: bcs.u32()
    } });
export const Utxo = new MoveStruct({ name: `${$moduleName}::Utxo`, fields: {
        id: UtxoId,
        amount: bcs.u64(),
        derivation_path: bcs.option(bcs.Address)
    } });
export const UtxoInfo = new MoveStruct({ name: `${$moduleName}::UtxoInfo`, fields: {
        id: UtxoId,
        amount: bcs.u64(),
        derivation_path: bcs.option(bcs.Address)
    } });
...
export interface DerivationPathOptions {
    package?: string;
    arguments: DerivationPathArguments | [
        self: RawTransactionArgument<string>
    ];
}
