...
const $moduleName = 'hashi::proposal';
export function Proposal<T extends BcsType<any>>(...typeParameters: [
    T
]) {
    return new MoveStruct({ name: `${$moduleName}::Proposal<${typeParameters[0].name as T['name']}>`, fields: {
            id: bcs.Address,
            creator: bcs.Address,
...
export interface QuorumReachedOptions {
    package?: string;
    arguments: QuorumReachedArguments | [
        proposal: RawTransactionArgument<string>,
        hashi: RawTransactionArgument<string>
    ];
    typeArguments: [
...
export interface DeleteExpiredOptions {
    package?: string;
    arguments: DeleteExpiredArguments | [
        hashi: RawTransactionArgument<string>,
        proposalId: RawTransactionArgument<string>
    ];
    typeArguments: [
