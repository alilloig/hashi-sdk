...
export function submitDkgCert(options: SubmitDkgCertOptions) {
    ...
    const parameterNames = ["hashi", "epoch", "dealer", "messagesHash", "signature", "signersBitmap"];
...
export function submitNonceCert(options: SubmitNonceCertOptions) {
    ...
    const parameterNames = ["hashi", "epoch", "batchIndex", "dealer", "messagesHash", "signature", "signersBitmap"];
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'cert_submission',
