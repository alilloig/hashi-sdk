...
const $moduleName = 'hashi::validator';
export const ValidatorRegistered = new MoveStruct({ name: `${$moduleName}::ValidatorRegistered`, fields: {
        validator: bcs.Address
    } });
export const ValidatorUpdated = new MoveStruct({ name: `${$moduleName}::ValidatorUpdated`, fields: {
        validator: bcs.Address
    } });
...
export interface UpdateNextEpochPublicKeyOptions {
    package?: string;
    arguments: UpdateNextEpochPublicKeyArguments | [
        self: RawTransactionArgument<string>,
        validator: RawTransactionArgument<string>,
        nextEpochPublicKey: RawTransactionArgument<number[]>,
        proofOfPossessionSignature: RawTransactionArgument<number[]>
...
export interface UpdateOperatorAddressOptions {
    package?: string;
    arguments: UpdateOperatorAddressArguments | [
        self: RawTransactionArgument<string>,
        validator: RawTransactionArgument<string>,
        operator: RawTransactionArgument<string>
    ];
...
export interface UpdateEndpointUrlOptions {
    package?: string;
    arguments: UpdateEndpointUrlArguments | [
        self: RawTransactionArgument<string>,
        validator: RawTransactionArgument<string>,
        endpointUrl: RawTransactionArgument<string>
    ];
...
export interface UpdateTlsPublicKeyOptions {
    package?: string;
    arguments: UpdateTlsPublicKeyArguments | [
        self: RawTransactionArgument<string>,
        validator: RawTransactionArgument<string>,
        tlsPublicKey: RawTransactionArgument<number[]>
    ];
...
export interface UpdateNextEpochEncryptionPublicKeyOptions {
    package?: string;
    arguments: UpdateNextEpochEncryptionPublicKeyArguments | [
        self: RawTransactionArgument<string>,
        validator: RawTransactionArgument<string>,
        nextEpochEncryptionPublicKey: RawTransactionArgument<number[]>
    ];
}
export function updateNextEpochEncryptionPublicKey(options: UpdateNextEpochEncryptionPublicKeyOptions) {
    const packageAddress = options.package ?? 'hashi';
    const argumentsTypes = [
        null,
        'address',
